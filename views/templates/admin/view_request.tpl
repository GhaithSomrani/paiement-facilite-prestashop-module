        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            {elseif $pf_request->organisation_autre}
              <p><span class="pf-label">{l s='Autre' mod='paiementfacilite'} :</span> {$pf_request->organisation_autre|escape:'html'}</p>
            {else}
        ...
        <div class="row">
          <div class="col-sm-3">
            <div class="pf-kpi">
              ...
              <div class="pf-kpi-value">{$pf_request->credit_amount|string_format:"%.2f"} <span class="pf-kpi-unit">DT</span></div>
            </div>
          </div>
          <div class="col-sm-3">
            <div class="pf-kpi">
              <div class="pf-kpi-label">{l s='1ère tranche' mod='paiementfacilite'}</div>
              <div class="pf-kpi-value">{$pf_request->premiere_tranche|string_format:"%.2f"} <span class="pf-kpi-unit">DT</span></div>
            </div>
          </div>
          <div class="col-sm-3">
            <div class="pf-kpi">
...
.pf-type-company  { background: #2980b9; }
.pf-type-employee { background: #7f8c8d; }
.pf-type-partner  { background: #27ae60; }

/* ── Client card ── */
.pf-client-name  { font-size: 15px; font-weight: 700; margin-bottom: 2px; }
.pf-client-email { color: #7f8c8d; margin-bottom: 8px; }
.pf-org-name     { font-size: 14px; font-weight: 600; margin-top: 8px; }

/* ── Info table (replaces dl-horizontal) ── */
.pf-info-table    { width: 100%; border-collapse: collapse; font-size: 13px; }
.pf-info-table th { width: 40%; color: #7f8c8d; font-weight: 600; padding: 3px 8px 3px 0; vertical-align: top; white-space: nowrap; }
.pf-info-table td { padding: 3px 0; }

/* ── Address ── */
.pf-address { font-size: 13px; line-height: 1.7; margin: 0; }

/* ── Field label / value (company section) ── */
.pf-field-label { font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: .05em; color: #95a5a6; margin-bottom: 3px; }
.pf-field-value { font-size: 14px; font-weight: 600; margin-bottom: 0; }
...
.pf-kpi-unit { font-size: .9rem; font-weight: 500; }

/* ── Order link inside KPI ── */
.pf-order-link { font-size: 1.4rem; font-weight: 700; }
.pf-order-link i { font-size: .9rem; }

/* ── Comment ── */
.pf-comment { font-size: 13px; line-height: 1.6; background: #f8f9fa; border-left: 3px solid #bdc3c7; padding: 8px 12px; border-radius: 0 3px 3px 0; margin: 0; }

/* ── Misc ── */
.pf-label  { font-weight: 600; color: #7f8c8d; }
.pf-none   { color: #bdc3c7; }
.pf-table-wrap { padding: 0; }
.pf-table-wrap table { margin: 0; }
.pf-col-action { width: 130px; }
</style>
