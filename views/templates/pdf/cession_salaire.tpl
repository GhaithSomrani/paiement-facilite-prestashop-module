...
<table style="width: 100%;" cellpadding="0" cellspacing="0">
  <tr>
    <td style="width: 50%; vertical-align: middle;">
      ...
      {else}
        <span style="font-size: 24pt; font-weight: bold; letter-spacing: 2px;">{$cs_shop_name|upper|escape:'html'}</span>
      {/if}
    </td>
    <td style="width: 50%; text-align: right; vertical-align: middle; font-size: 9pt; color: #333; line-height: 2.0;">
      &#x2295; {$cs_shop_domain|escape:'html'}<br/>
      &#x2709; {$cs_shop_email|escape:'html'}<br/>
      &#x260E; {$cs_shop_phone|escape:'html'}
    </td>
  </tr>
</table>
...
{* ── TITLE ── *}
<p style="text-align: center; font-size: 22pt; font-weight: bold; margin: 0 0 3mm; letter-spacing: 1px;">CESSION SUR SALAIRE</p>
...
<table style="width: 100%; font-size: 11pt;" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td style="padding: 2mm 4mm 2mm 0; vertical-align: top;">
      - Adresse : <b>{$cs_address->address1|escape:'html'}{if $cs_address->address2}, {$cs_address->address2|escape:'html'}{/if}{if $cs_address->postcode} {$cs_address->postcode|escape:'html'}{/if}</b>
    </td>
    <td style="padding: 2mm 0 2mm 4mm; vertical-align: top;">
...
<table style="width: 100%; font-size: 11pt;" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="2" style="padding: 2mm 0;">
      - Période (D'échéance) : Du&nbsp;: <b>{$cs_period_start|escape:'html'}</b> &nbsp;&nbsp; Au&nbsp;: <b>{$cs_period_end|escape:'html'}</b>
    </td>
  </tr>
</table>
...
<table style="width: 100%;" cellpadding="2" cellspacing="0">
  <tr>
    <td style="width: 25%; text-align: center; font-weight: bold; font-size: 11pt; height: 28mm; vertical-align: top;">CLIENT</td>
    <td style="width: 25%; text-align: center; font-weight: bold; font-size: 11pt; height: 28mm; vertical-align: top;">AMICALE</td>
    <td style="width: 25%; text-align: center; font-weight: bold; font-size: 11pt; height: 28mm; vertical-align: top;">DIRECTION DE PAIE</td>
    <td style="width: 25%; text-align: center; font-weight: bold; font-size: 11pt; height: 28mm; vertical-align: top;">{$cs_shop_name|upper|escape:'html'}</td>
  </tr>
</table>
