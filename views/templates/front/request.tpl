...
<div class="pf-wrapper">
  ...
  <form id="pf-form"
      ...
      <div id="pf-org-autre-block" style="display:none;">
        <div class="pf-field">
          ...
          <input type="text" name="organisation_autre" id="pf-org-autre"
                 maxlength="255" placeholder="{l s='Précisez le nom' mod='paiementfacilite'}">
        </div>
      </div>
    ...
    <section class="pf-section pf-step-panel" data-step="3">
      ...
      {if $pf_is_from_checkout && $pf_selected_address_id}
        <div class="pf-notice mb-3">
          <strong style="font-size:10px;letter-spacing:.06em;text-transform:uppercase;">{l s='Adresse de facturation' mod='paiementfacilite'}</strong><br>
    ...
    <section class="pf-section pf-step-panel" data-step="4">
      ...
      <div class="pf-nav">
        <button type="button" class="pf-btn-prev pf-prev-btn">← {l s='Précédent' mod='paiementfacilite'}</button>
        <button type="button" class="pf-btn-next pf-next-btn" data-validates-step="4">{l s='Suivant' mod='paiementfacilite'} →</button>
      </div>
    </section>
